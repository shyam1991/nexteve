  ...
  <body>
  <header>
      <div class="container-fluid" style="background: #444444; padding: 1%;">
          ...
          <div class="col-md-8 hidden-xs">
              <h3 class="pull-right"><a href="" style="color: #fff; text-decoration: none; ">+91 9447 520986 </a></h3>
          </div>
      </div>
  </header>
      ...
      <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
          <div class="search-menu">
              <div class="input-group" id="adv-search">
                  <input type="text" class="form-control search-data" placeholder="Search for snippets" name="search"/>
